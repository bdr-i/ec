...
// G�n�re une liste cha�n�e al�atoire de taille n (valeurs 0-99)
...
// Lib�re la m�moire d'une liste cha�n�e
...
int main() {
    ...
    do {
        ...
        // G�n�ration et affichage de la liste
        Node* head = generateRandomList(size);
        printf("\nListe avant tri : ");
        print_list(head);

        // Temps d'ex�cution du tri
        clock_t start = clock();
